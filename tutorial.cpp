...
{
	//マップの床
	InitMeshField(XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(0.0f, 0.0f, 0.0f), (int)(CLEARSTAGEWALL_SIZE_X / FLOOR_BLOCK_SIZE) + 10, (int)(CLEARSTAGEWALL_SIZE_Z / FLOOR_BLOCK_SIZE) + 10, FLOOR_BLOCK_SIZE, FLOOR_BLOCK_SIZE, GROUND);
	...
	InitMeshWall(XMFLOAT3((CLEARSTAGEWALL_SIZE_Z*0.5f) - CLEARSTAGE_DOOR * 0.5f, 1.0f, CLEARSTAGEWALL_SIZE_X * 0.5f), XMFLOAT3(0.0f, 0.0f, 0.0f),
		XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f), WALL_XZ, WALL_Y, CLEARSTAGEWALL_SIZE_Z*0.5f - CLEARSTAGE_DOOR, TUTORIALWALL_SIZE_Y, WALL_BLACK);
	...
	InitMeshWall(XMFLOAT3(-CLEARSTAGEWALL_SIZE_Z * 0.5f, 1.0f, 0.0f), XMFLOAT3(0.0f, -XM_PI * 0.50f, 0.0f),
		XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f), WALL_XZ, WALL_Y, CLEARSTAGEWALL_SIZE_X, TUTORIALWALL_SIZE_Y, WALL_BLACK);
	InitMeshWall(XMFLOAT3(CLEARSTAGEWALL_SIZE_Z * 0.5f, 1.0f, 0.0f), XMFLOAT3(0.0f, XM_PI * 0.50f, 0.0f),
		XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f), WALL_XZ, WALL_Y, CLEARSTAGEWALL_SIZE_X, TUTORIALWALL_SIZE_Y, WALL_BLACK);
	InitMeshWall(XMFLOAT3(0.0f, 1.0f, -CLEARSTAGEWALL_SIZE_X * 0.5f), XMFLOAT3(0.0f, XM_PI, 0.0f),
		XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f), WALL_XZ, WALL_Y, CLEARSTAGEWALL_SIZE_Z, TUTORIALWALL_SIZE_Y, WALL_BLACK);
