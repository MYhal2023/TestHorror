...
void InitSetTutorial(void)
{
	...
	InitMeshWall(XMFLOAT3(-DOOR_SIZE * 0.0f, 0.0f, TUTORIALWALL_SIZE_XZ*0.5f), XMFLOAT3(0.0f, 0.0f, 0.0f),
		XMFLOAT4(1.0f, 1.0f, 1.0f, 0.5f), WALL_XZ, WALL_Y, DOOR_SIZE, DOOR_SIZE, WALL_RAY);
	...
	InitMeshWall(XMFLOAT3(TUTORIALWALL_SIZE_XZ*0.5f - PRISONSIDE_SIZE_XZ, 0.0f, -TUTORIALWALL_SIZE_XZ * 0.5f + DOOR_SIZE * 0.5f), XMFLOAT3(0.0f, XM_PI * 0.50f, 0.0f),
		XMFLOAT4(1.0f, 1.0f, 1.0f, 0.5f), WALL_XZ, WALL_Y, DOOR_SIZE, DOOR_SIZE, WALL_RAY);
	...
	for (int i = 0; i < ROOM; i++)
	{
		...
		SetBedWall(XMFLOAT3(-TUTORIALWALL_SIZE_XZ * 0.5f + PRISONSIDE_SIZE_XZ - BED_SHIFT_X, 1.0f, room * i + room * 0.5f - (TUTORIALWALL_SIZE_XZ * 0.5f) - (DOOR_SIZE*0.5f) + BED_SHIFT_Z), 0.0f);
		...
		SetToiletWall(XMFLOAT3(-TUTORIALWALL_SIZE_XZ * 0.5f + PRISONSIDE_SIZE_XZ - TOILET_SHIFT_X, 1.0f, room * i + room * 0.5f - (TUTORIALWALL_SIZE_XZ * 0.5f) - (DOOR_SIZE*0.5f) + TOILET_SHIFT_Z));
